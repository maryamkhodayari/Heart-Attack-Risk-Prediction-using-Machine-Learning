...
model.fit(X_standard_train, y_train)

#تست مدل
risk = model.predict(X_standard_test)

#بررسی جزئیات عملکرد مدل
print("Predictions:", risk[:5])
print("test:", y_test[:5])
print("Accuracy:", model.score(X_standard_test, y_test))
...
#استاندارد سازی کاربر جدید
new_patient = standard.transform(new_patient)
